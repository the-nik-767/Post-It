    ...
    const ImgProfile = (props) => {
        return (
            <View style={{ flexDirection: "row", alignItems: "flex-end" }}>
                <Image source={props.urll ? { uri: props.urll } : icons.ic_profile} resizeMode="contain" style={styles.draggableimgicon} />
            </View>
        )
    }
    ...
    return (
        <View >
            <Draggable
                ...
                renderSize={65}
                x={responsiveWidth("3%")}
                y={responsiveWidth("49%")}
                minX={responsiveWidth("2%")}
                maxX={responsiveWidth("99%")}
                minY={responsiveWidth("1%")}
                maxY={responsiveWidth("69%")}
...
export default DraggabelPartyIcon
